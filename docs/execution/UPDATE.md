...
Diretriz posterior registrada: backend, persistência e integrações reais ficam para depois da fase frontend M01–M22. Após cada aceite UX, suas pendências não bloqueiam a próxima fatia mockada. A aprovação UX de M01 foi registrada; nenhum código foi alterado nesta atualização.
...
Evidências: [retomada](../milestones/M01-onboarding/evidence/RESUME.md).
