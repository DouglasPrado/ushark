...
Resolver riscos materiais de M11 com evidência.
...
Exercitar riscos: Especial/ordem de episódios, contagem antecipada, erro de seleção e prefetch excessivo. Validar limites de entrada/recursos, privacidade, recuperação, responsividade/foco e NFRs da cobertura nas superfícies introduzidas; segurança necessária já acompanha S04.
