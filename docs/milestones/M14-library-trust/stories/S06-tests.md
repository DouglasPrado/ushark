# S06 — Testes da jornada — M14

Status: DEFERRED; preparada documentalmente, não executada.

## Objetivo

Consolidar regressões que protegem cliente verifica assinatura e lembra a identidade aceita; autor pode assinar pacote.
...
Cobrir invariantes de domínio/contrato, falhas de adapters e E2E pertinentes. Casos obrigatórios: Modificar bytes invalida assinatura; chave diferente nunca entra silenciosamente; não assinado é identificado; roundtrip preserva assinatura; verificar ausência de chave privada em DB/logs. Reutilizar checks das stories anteriores e rastrear requisitos individuais.
