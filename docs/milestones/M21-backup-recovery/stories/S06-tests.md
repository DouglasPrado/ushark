# S06 — Testes da jornada — M21

Status: DEFERRED; preparada documentalmente, não executada.

## Objetivo

Consolidar regressões que protegem usuário restaura backup consistente e volta a navegar/retomar sem perda silenciosa.
...
Cobrir invariantes de domínio/contrato, falhas de adapters e E2E pertinentes. Casos obrigatórios: Backup durante uso restaura em perfil isolado; injetar crash UI/Core/torrentd/MPV, DB lock/disk full/migração falha; manter original e restaurar estado/subscriptions/config; shutdown nunca espera indefinidamente. Reutilizar checks das stories anteriores e rastrear requisitos individuais.
